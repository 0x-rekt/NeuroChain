...
async def create_node_handler(text: str, contributor: str = None) -> CreateNodeResponse:
    """
    ...
    try:
        ...
        logger.info(f"Processing thought from {contributor or 'anonymous'}: \"{trimmed_text[:80]}...\"")
